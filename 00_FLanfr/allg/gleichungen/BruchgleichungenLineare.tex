...
\begin{definition}{Definitionsmenge}{definition_definitionsmenge}\index{Definitionsmenge}
...
\textbf{Bemerkung:}\\ Ist keine Grundmenge $\mathbb{G}$ explizit angegeben rechnen wir immer in $\mathbb{G=R}$.
...
Probe a) liegt die Lösung im Definitionsbereich\index{Definitionsmenge}\index{Definitionsbereich|see{Definitionsmenge}} $x \in \mathbb{D}$? (ja)
Probe b) stimmt die Lösung in der ursprünglichen Gleichung? (ja)\\


$$\Rightarrow \lx=\left\{\frac{-3}{5}\right\}$$
...
\begin{rezept}{Bruchgleichungen}{}
  ...
  \item Definitive Lösungsmenge $\mathbb{L}$ angeben
    \end{itemize}
\GESO{  Quelle: \cite{marthaler21alg} Seite 120}
\end{rezept}

\subsection*{Aufgaben}

\input{allg/gleichungen/BruchgleichungenLineare_Aufgaben}
