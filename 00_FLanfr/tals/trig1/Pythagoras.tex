...
\section{Dreiecke}\index{Dreieck!rechtwinkliges}\index{rechtwinkliges Dreieck}
...
\begin{itemize}
 \item Satz des Pythagoras anwenden
 \item Winkelsumme = 180\degre
 \item Höhensatz
...
\subsection{Satz des Pythagoras}\index{Pythagoras!Trigonometrie}\index{Satz des Pythagoras!Trigonometrie}
...
\subsection{Winkelsumme im Dreieck}\index{Dreiecke!Winkelsumme}

\begin{gesetz}{Winkelsumme im Dreieck}{}
In jdem Dreieck mit Winkeln $\alpha$, $\beta$ und $\gamma$ gilt:
$$\alpha + \beta + \gamma = 180\degre$$
\end{gesetz}
